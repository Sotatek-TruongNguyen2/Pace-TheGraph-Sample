...
export class RoyaltiesSet__Params {
  ...
  get royalties(): RoyaltiesSetRoyaltiesStruct {
    return changetype<RoyaltiesSetRoyaltiesStruct>(
...
export class PaceArtStore__getPaceArtV2RoyaltiesResultValue0Struct extends ethereum.Tuple {
  get account(): Address {
    return this[0].toAddress();
  }
...
export class PaceArtStore__mintToInput_royaltyStruct extends ethereum.Tuple {
  get account(): Address {
    return this[0].toAddress();
  }
...
export class PaceArtStore__royaltiesResult {
  value0: Address;
  value1: BigInt;
...
export class PaceArtStore extends ethereum.SmartContract {
  static bind(address: Address): PaceArtStore {
    return new PaceArtStore("PaceArtStore", address);
  }
  ...
  getPaceArtV2Royalties(
    id: BigInt
  ): PaceArtStore__getPaceArtV2RoyaltiesResultValue0Struct {
    let result = super.call(
      "getPaceArtV2Royalties",
      "getPaceArtV2Royalties(uint256):((address,uint96))",
      [ethereum.Value.fromUnsignedBigInt(id)]
    );

    return result[0].toTuple() as PaceArtStore__getPaceArtV2RoyaltiesResultValue0Struct;
  }

  try_getPaceArtV2Royalties(
    id: BigInt
  ): ethereum.CallResult<
    PaceArtStore__getPaceArtV2RoyaltiesResultValue0Struct
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as PaceArtStore__getPaceArtV2RoyaltiesResultValue0Struct
    );
  }
  ...
  mintTo(
    _to: Address,
    _royalty: PaceArtStore__mintToInput_royaltyStruct
  ): BigInt {
    let result = super.call(
      "mintTo",
  ...
  royalties(param0: BigInt): PaceArtStore__royaltiesResult {
    let result = super.call(
      "royalties",
    ...
    return new PaceArtStore__royaltiesResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royalties(
    param0: BigInt
  ): ethereum.CallResult<PaceArtStore__royaltiesResult> {
    let result = super.tryCall(
      "royalties",
      "royalties(uint256):(address,uint96)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PaceArtStore__royaltiesResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
